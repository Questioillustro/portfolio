...
@font-face {
  ...
  // note: add paths from src directory to get glyphicons to show
  ...
  src: url('../node_modules/my-bootstrap-styl/fonts/glyphicons-halflings-regular.eot');
  src: url('../node_modules/my-bootstrap-styl/fonts/glyphicons-halflings-regular.eot?#iefix') format('embedded-opentype'), url('../node_modules/my-bootstrap-styl/fonts/glyphicons-halflings-regular.woff') format('woff'), url('../node_modules/my-bootstrap-styl/fonts/glyphicons-halflings-regular.ttf') format('truetype'), url('../node_modules/my-bootstrap-styl/fonts/glyphicons-halflings-regular.svg#glyphicons_halflingsregular') format('svg');
}
.glyphicon {
  position: relative;
  top: 1px;
