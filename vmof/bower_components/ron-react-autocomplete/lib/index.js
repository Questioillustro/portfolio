...
var Autocomplete = React.createClass({displayName: 'Autocomplete',
  ...
  render: function() {
    ...
    return (
      React.DOM.div({
        ...
        style: style}, 
        /*React.DOM.form({
          className: "react-autocomplete-Autocomplete__form",
          //onSubmit: this.props.handleSubmit
          onSubmit: function(e) { e.preventDefault(); } //this.props.handleSubmit
        },*/ 
        React.DOM.input({
          ref: "search", 
  ...
  onQueryKeyDown: function(e) {
    ...
    if (e.key === 'Enter') {
      ...
      //this.props.handleSubmit(this.state.focusedValue.title);
      //this.props.handleChange(this.state.focusedValue.title);
...
var Results = React.createClass({displayName: 'Results',
  ...
  render: function() {
    ...
    // );
    // return 
    //   React.DOM.ul(Object.assign({}, this.props, {style: style, className: "react-autocomplete-Results"}, 
    //     this.props.results.map(this.renderResult)
    //   ));
    // return React.DOM.ul(
    //           Object.assign(
    //             {}, this.props,
    //             {style: style, className: "react-autocomplete-Results"}
    //           ),
    //           this.props.results.map(this.renderResult)
    //        );
    return React.DOM.ul(
  ...
  renderResult: function(result) {
    ...
    //return React.DOM.span(null, "yo"); /*React.createElement(renderer, {
...
var Result = React.createClass({displayName: 'Result',
  ...
  onClick: function() {
    ...
    //this.props.handleSubmit(this.props.result.title);
    //document.getElementsByClassName("react-autocomplete-Autocomplete__form")[0].submit();
  },
